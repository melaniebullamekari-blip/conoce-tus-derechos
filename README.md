...
- **Corpus público.** Solo fuentes públicas y oficiales colombianas.
  - [x] Verificado con leyes oficiales cargadas en el repositorio.
- **Anti-alucinaciones.** Cita de normas y reconocimiento explícito cuando no hay información.
  - [x] Verificado en los casos de prueba [casos-de-prueba.md](./casos-de-prueba.md).
---
...
- [x] 👤 **Usuario real**: evidencia documentada en [evidencia-usuario.md](./evidencia-usuario.md).
